...
if (( $+commands[eza] )); then
    ...
    alias ls="eza -alg --git $_eza_opts"               # Default 'ls' override
    alias llm='eza -lbGF --git --sort=modified'    # long list, modified date sort
    alias la='eza -a $_exa_opts --time-style=long-iso --git --color-scale'  # all list
...
alias kickass='java -jar ~/coding/c64/tools/KickAssembler/KickAss.jar'
